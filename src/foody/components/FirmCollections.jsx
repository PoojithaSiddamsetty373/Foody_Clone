...
const FirmCollection = () => {
    ...
    const firmDataHandler = async () => {
        try {
            ...
            console.log("firmData Displayed", newFirmData)
        }
        catch (error) {
    ...
    return (
        ...
        <>
            ...
            <div className="filterButtons1">
                ...
                <button  onClick={() => filterHandler("Chineese",'chinese')}className={activeCategory === 'chinese'? 'activeButton':''}>Chineese</button>
